    ...
    public class SKS : Gun
    {
        ...
        public override void Update()
        {
            ...
            if (duck.inputProfile.Pressed("QUACK"))
            {
                ...
                _flare = new SpriteMap(GetPath("takezis"), 4, 4) {center = new Vec2(0f, 0f)};
                _ammoType = new ATNB();
                _fullAuto = false;
                _fireWait = 0.1f;
            ...
            ammo = _patrons;
            _ammoType = new AT9mm {range = 900f, accuracy = 0.91f, penetration = 1f, bulletSpeed = 75f};
            _fullAuto = false;
            _fireWait = 1.3f;
            _numBulletsPerFire = 1;
            ...
            _kickForce = 0.6f;
            _flare = new SpriteMap("smallFlare", 11, 10) {center = new Vec2(0f, 4f)};
            _stick = false;
        }	
